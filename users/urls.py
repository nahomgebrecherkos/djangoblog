...
urlpatterns = [
    ...
    path('', auth_view.LoginView.as_view(template_name='users/log_in.html'), name='users-login'),
    path('logout/', auth_view.LogoutView.as_view(template_name='users/log_out.html'), name='users-logout'),
